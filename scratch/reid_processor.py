...
# 允許從 repo 根目錄執行：python scratch/reid_processor.py
_REPO = Path(__file__).resolve().parents[1]
if str(_REPO) not in sys.path:
    sys.path.insert(0, str(_REPO))

from kv.paths import memory_dir, metrics_dir  # noqa: E402
...
if __name__ == "__main__":
    ...
    print("🚀 啟動 Kinder Vision 自動歸戶處理器（scratch 示範，路徑已改為 repo/memory）...")
